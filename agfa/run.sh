...
./tabula.sh -o "agfa/chunk0.json" -p 25 -a 50,61,400,1000 "agfa/000946_tcm583-21755.pdf"
...
./tabula.sh -o "agfa/chunk0.json" -p 16 -a 100,50,250,1000 "agfa/000946_tcm583-21755.pdf"
